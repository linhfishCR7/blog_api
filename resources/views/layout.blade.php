...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">@yield('feature-title')</h1>
    ...
    <script src="{{ asset('themes/sb-admin/assets/demo/chart-area-demo.js')}}"></script>
    <script src="{{ asset('themes/sb-admin/assets/demo/chart-bar-demo.js')}}"></script>
