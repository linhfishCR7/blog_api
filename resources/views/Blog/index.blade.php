        ...
        <table id="datatablesSimple">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="{{ asset('storage/upload/'.$blogPost->feature_image_url) }}" alt="hinh san pham" class="img-fluid" height="100" width="100"></td>
                    ...
                    <td>
                        ...
                        |
                        <form method="POST" action="{{URL::to('delete-blog-post')}}/{{$blogPost->id}}" class="frmDelete" data-id="{{$blogPost->id}}">
                            {{ csrf_field() }}
